...
import mac.training.android.com.org.materialdesignbasic.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    private static final String TAG = FragmentDrawer.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImageViewAvatar = (ImageView) rootView.findViewById(R.id.mImageViewAvatar);
        Glide.with(this)
                .load("http://vignette3.wikia.nocookie.net/clubpenguin/images/4/47/1433_icon.png/revision/latest?cb=20120705152241")
                .centerCrop()
                .fitCenter()
